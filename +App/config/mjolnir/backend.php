			...
			(
				'user-index' => array
					(
						...
						'view' => 'mjolnir/access/backend/user-index'
					),
				'user-edit' => array
					(
						'hidden' => true,
						'title' => 'Edit User',
						'context' => '\app\Backend_User',
						'view' => 'mjolnir/access/backend/user-edit'
					),
				'user-edit-profile' => array
					(
						...
						'context' => '\app\Backend_User',
						'view' => 'mjolnir/access/backend/user-edit-profile'
					),
				'user-profile' => array
					(
						'hidden' => true,
						'title' => 'View Profile',
						'context' => '\app\Backend_User',
						'view' => 'mjolnir/access/backend/user-profile'
					),
				'user-role-index' => array
					(
						...
						'view' => 'mjolnir/access/backend/role-index'
					),
				'user-role-edit' => array
					(
						...
						'title' => 'Edit Role',
						'context' => '\app\Backend_Role',
						'view' => 'mjolnir/access/backend/role-edit'
					),
